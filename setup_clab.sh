...
# Réinstalle les paquets essentiels
echo "Réinstallation de libc-bin et init..."
sudo apt-get install --reinstall -y libc-bin init

# Assure-toi que le PATH est correct
echo "Correction du PATH..."
